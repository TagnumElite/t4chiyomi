...
import eu.kanade.t4chiyomi.data.database.models.ChapterImpl
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_BOOKMARK
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_CHAPTER_NUMBER
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_DATE_FETCH
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_DATE_UPLOAD
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_ID
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_LAST_PAGE_READ
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_MANGA_ID
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_NAME
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_READ
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_SCANLATOR
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_SOURCE_ORDER
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.COL_URL
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable.TABLE
