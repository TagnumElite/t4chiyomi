...
import eu.kanade.t4chiyomi.data.database.models.TrackImpl
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_ID
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_LAST_CHAPTER_READ
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_LIBRARY_ID
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_MANGA_ID
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_MEDIA_ID
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_SCORE
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_STATUS
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_SYNC_ID
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_TITLE
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_TOTAL_CHAPTERS
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.COL_TRACKING_URL
import eu.kanade.t4chiyomi.data.database.tables.TrackTable.TABLE
