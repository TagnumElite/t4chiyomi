...
import eu.kanade.t4chiyomi.data.database.models.MangaCategory
import eu.kanade.t4chiyomi.data.database.tables.MangaCategoryTable.COL_CATEGORY_ID
import eu.kanade.t4chiyomi.data.database.tables.MangaCategoryTable.COL_ID
import eu.kanade.t4chiyomi.data.database.tables.MangaCategoryTable.COL_MANGA_ID
import eu.kanade.t4chiyomi.data.database.tables.MangaCategoryTable.TABLE
