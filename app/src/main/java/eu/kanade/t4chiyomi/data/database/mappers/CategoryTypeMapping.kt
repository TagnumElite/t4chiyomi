...
import eu.kanade.t4chiyomi.data.database.models.CategoryImpl
import eu.kanade.t4chiyomi.data.database.tables.CategoryTable.COL_FLAGS
import eu.kanade.t4chiyomi.data.database.tables.CategoryTable.COL_ID
import eu.kanade.t4chiyomi.data.database.tables.CategoryTable.COL_NAME
import eu.kanade.t4chiyomi.data.database.tables.CategoryTable.COL_ORDER
import eu.kanade.t4chiyomi.data.database.tables.CategoryTable.TABLE
