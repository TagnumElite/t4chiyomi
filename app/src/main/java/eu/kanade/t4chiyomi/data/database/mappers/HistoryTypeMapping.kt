...
import eu.kanade.t4chiyomi.data.database.models.HistoryImpl
import eu.kanade.t4chiyomi.data.database.tables.HistoryTable.COL_CHAPTER_ID
import eu.kanade.t4chiyomi.data.database.tables.HistoryTable.COL_ID
import eu.kanade.t4chiyomi.data.database.tables.HistoryTable.COL_LAST_READ
import eu.kanade.t4chiyomi.data.database.tables.HistoryTable.COL_TIME_READ
import eu.kanade.t4chiyomi.data.database.tables.HistoryTable.TABLE
