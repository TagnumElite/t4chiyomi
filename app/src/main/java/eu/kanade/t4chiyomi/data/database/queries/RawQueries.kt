...
import eu.kanade.t4chiyomi.data.database.tables.CategoryTable as Category
import eu.kanade.t4chiyomi.data.database.tables.ChapterTable as Chapter
import eu.kanade.t4chiyomi.data.database.tables.HistoryTable as History
import eu.kanade.t4chiyomi.data.database.tables.MangaCategoryTable as MangaCategory
import eu.kanade.t4chiyomi.data.database.tables.MangaTable as Manga
